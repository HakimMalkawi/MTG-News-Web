...
const Settings = props => {
    ...
    const hideSettings = () => {
        ...
        setTimeout(() => props.setOptions(prevOptions => ({ ...prevOptions, settings: !prevOptions.settings } ) ), 1500 ) }
    ...
    return <>  <main className="settings-container">
                    ...
                    <ul className="settings-options">
                        <li onClick={ () => props.setDarkMode(prevDarkMode => !prevDarkMode)} className="settings-options-color">Dark Mode</li>
                    </ul>
                </main>  </> }
